...
<BlogImage dark={Period1Dark} light={Period1Light} alt="ABC" />
...
<BlogImage dark={Period2Dark} light={Period2Light} alt="ABC" />
...
<BlogImage dark={Period4Dark} light={Period4Light} alt="ABC" />
...
<BlogImage dark={Period8Dark} light={Period8Light} alt="ABC" />
...
<BlogImage dark={PeriodChaosDark} light={PeriodChaosLight} alt="ABC" />
...
<BlogImage dark={ChaosDark} light={ChaosLight} alt="ABC" />
