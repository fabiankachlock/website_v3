...
<BlogImage dark={Period1Dark} light={Period1Light} alt="Here you can see, how the population evolves, for this exact parameter (r = 2)." />
...
<BlogImage dark={Period8Dark} light={Period8Light} alt="A period of 8. It's crazy how a simple function like this can create patterns like these." />
...
<BlogImage dark={PeriodChaosDark} light={PeriodChaosLight} alt="Chaos! It's almost sad that nothing of this is random, just pure math." />
